			       ...
			       u16 cp_len[RTL8125_CP_NUM])
{
	...
	count = 0;
	while (!(rtl8125_mdio_read(tp, 0x11) & BIT_15) && (count++ < 200))
		msleep(100);
				    ...
				    int count, int *eof, void *data)
{
	...
	len += snprintf(
...
#ifdef ENABLE_PAGE_REUSE
		tp->rx_buf_page_order, tp->rx_buf_page_size,
		tp->page_reuse_fail_cnt,
#endif //ENABLE_PAGE_REUSE
		...
		proc_init_num, s0_magic_packet, disable_pm_support,
		enable_double_vlan, tp->HwSuppMagicPktVer,
...
static int proc_get_cable_info(char *page, char **start, off_t offset,
			       int count, int *eof, void *data)
{
	int i;
	u16 status;
	...
	for (i = 0; i < RTL8125_CP_NUM; i++)
		len += snprintf(page + len, count - len, "%d-%d\t%d\t%s\n",
				i + 1, i + 2, cp_len[i],
				rtl8125_get_cp_status_string(cp_status[i]));
...
static void rtl8125_disable_rx_packet_filter(struct rtl8125_private *tp)
{
	RTL_W32(tp, RxConfig,
		RTL_R32(tp, RxConfig) &
				  ...
				  u8 duplex, u64 adv)
{
	...
	if (speed != SPEED_5000 && speed != SPEED_2500 &&
...
static void rtl8125_set_mac_mcu_8126a_1(struct net_device *dev)
{
	struct rtl8125_private *tp = netdev_priv(dev);
	static const u16 mcu_patch_code_8126a_1[] = {
		0xE010, 0xE019, 0xE01B, 0xE01D, 0xE01F, 0xE021, 0xE023, 0xE025,
		0xE027, 0xE029, 0xE02B, 0xE02D, 0xE02F, 0xE031, 0xE033, 0xE035,
		0x48C0, 0x9C66, 0x7446, 0x4840, 0x48C1, 0x48C2, 0x9C46, 0xC402,
		0xBC00, 0x0AD6, 0xC602, 0xBE00, 0x0000, 0xC602, 0xBE00, 0x0000,
		0xC602, 0xBE00, 0x0000, 0xC602, 0xBE00, 0x0000, 0xC602, 0xBE00,
		0x0000, 0xC602, 0xBE00, 0x0000, 0xC602, 0xBE00, 0x0000, 0xC602,
		0xBE00, 0x0000, 0xC602, 0xBE00, 0x0000, 0xC602, 0xBE00, 0x0000,
		0xC602, 0xBE00, 0x0000, 0xC602, 0xBE00, 0x0000, 0xC602, 0xBE00,
	...
	rtl8125_write_mac_mcu_ram_code(tp, mcu_patch_code_8126a_1,
...
static const u16 phy_mcu_ram_code_8125b_2[] = {
	...
	0x9caf, 0xa438, 0x889c, 0xa438, 0xaf88, 0xa438, 0x9caf, 0xa438, 0x889c,
	...
	0x32e6, 0xa438, 0xaf32, 0xa438, 0xfb00, 0xa436, 0xb87c, 0xa438, 0x8ff6,
	0xa436, 0xb87e, 0xa438, 0x0705, 0xa436, 0xb87c, 0xa438, 0x8ff8, 0xa436,
	0xb87e, 0xa438, 0x19cc, 0xa436, 0xb87c, 0xa438, 0x8ffa, 0xa436, 0xb87e,
	0xa438, 0x28e3, 0xa436, 0xb87c, 0xa438, 0x8ffc, 0xa436, 0xb87e, 0xa438,
	0x1047, 0xa436, 0xb87c, 0xa438, 0x8ffe, 0xa436, 0xb87e, 0xa438, 0x0a45,
	0xa436, 0xb85e, 0xa438, 0x271E, 0xa436, 0xb860, 0xa438, 0x3846, 0xa436,
	0xa438, 0x52c8, 0xa438, 0xe48f, 0xa438, 0xfee5, 0xa438, 0x8fff, 0xa438,
	0xbf53, 0xa438, 0x2202, 0xa438, 0x52c8, 0xa438, 0xa131, 0xa438, 0x03af,
	0xa438, 0x85a7, 0xa438, 0xd480, 0xa438, 0x00bf, 0xa438, 0x8684, 0xa438,
	0x0252, 0xa438, 0xa9bf, 0xa438, 0x8687, 0xa438, 0x0252, 0xa438, 0xa9bf,
	0xa438, 0x868a, 0xa438, 0x0252, 0xa438, 0xa9bf, 0xa438, 0x868d, 0xa438,
	0x0252, 0xa438, 0xa9ef, 0xa438, 0x95fd, 0xa438, 0xfc04, 0xa438, 0xf0d1,
	0xa438, 0x2af0, 0xa438, 0xd12c, 0xa438, 0xf0d1, 0xa438, 0x44f0, 0xa438,
	0xd146, 0xa438, 0xbf86, 0xa438, 0xa102, 0xa438, 0x52c8, 0xa438, 0xbf86,
	0xa438, 0xa102, 0xa438, 0x52c8, 0xa438, 0xd101, 0xa438, 0xaf06, 0xa438,
	0xa570, 0xa438, 0xce42, 0xa436, 0xb818, 0xa438, 0x043d, 0xa436, 0xb81a,
	0xa438, 0x06a3, 0xa436, 0xb81c, 0xa438, 0xffff, 0xa436, 0xb81e, 0xa438,
	0xffff, 0xa436, 0xb850, 0xa438, 0xffff, 0xa436, 0xb852, 0xa438, 0xffff,
	0xa436, 0xb878, 0xa438, 0xffff, 0xa436, 0xb884, 0xa438, 0xffff, 0xa436,
	0xb832, 0xa438, 0x0003, 0xa436, 0x0000, 0xa438, 0x0000, 0xa436, 0xB82E,
	0xa438, 0x0000, 0xa436, 0x8024, 0xa438, 0x0000, 0xa436, 0x801E, 0xa438,
	0x0021, 0xb820, 0x0000, 0xFFFF, 0xFFFF
};
...
static void rtl8125_real_set_phy_mcu_8126a_1_1(struct net_device *dev)
{
	rtl8125_set_phy_mcu_ram_code(dev, phy_mcu_ram_code_8126a_1_1,
				     ARRAY_SIZE(phy_mcu_ram_code_8126a_1_1));
}

static void rtl8125_real_set_phy_mcu_8126a_1_2(struct net_device *dev)
{
	rtl8125_set_phy_mcu_ram_code(dev, phy_mcu_ram_code_8126a_1_2,
				     ARRAY_SIZE(phy_mcu_ram_code_8126a_1_2));
}

static void rtl8125_real_set_phy_mcu_8126a_1_3(struct net_device *dev)
{
	rtl8125_set_phy_mcu_ram_code(dev, phy_mcu_ram_code_8126a_1_3,
				     ARRAY_SIZE(phy_mcu_ram_code_8126a_1_3));
}

static void rtl8125_set_phy_mcu_8126a_1(struct net_device *dev)
{
	struct rtl8125_private *tp = netdev_priv(dev);
...
static void rtl8125_hw_phy_config_8126a_1(struct net_device *dev)
{
	struct rtl8125_private *tp = netdev_priv(dev);
...
static void rtl8125_setup_mqs_reg(struct rtl8125_private *tp)
{
	...
	for (i = 0; i < R8125_MAX_TX_QUEUES; i++) {
		if (tp->HwSuppTxNoCloseVer == 4) {
			tp->tx_ring[i].hw_clo_ptr_reg =
				(u16)(HW_CLO_PTR0_8126 + i * 4);
			tp->tx_ring[i].sw_tail_ptr_reg =
				(u16)(SW_TAIL_PTR0_8126 + i * 4);
		} else {
			tp->tx_ring[i].hw_clo_ptr_reg =
				(u16)(HW_CLO_PTR0_8125 + i * 4);
			tp->tx_ring[i].sw_tail_ptr_reg =
...
static void rtl8125_init_software_variable(struct net_device *dev)
{
	...
	if (aspm) {
		...
		case CFG_METHOD_8:
			tp->org_pci_offset_180 =
				rtl8125_csi_fun0_read_byte(tp, 0x22c);
			break;
		}
	}
...
static void rtl8125_hw_address_set(struct net_device *dev,
...
static void rtl8125_get_stats64(struct net_device *dev,
...
#ifdef ENABLE_PAGE_REUSE
static inline unsigned int rtl8125_rx_page_order(unsigned rx_buf_sz,
						 unsigned page_size)
{
...
static int rtl8125_alloc_tx_desc(struct rtl8125_private *tp)
{
	...
	for (i = 0; i < tp->num_tx_rings; i++) {
		...
		ring->TxDescAllocSize =
			(ring->num_tx_desc + 1) * sizeof(struct TxDesc);
		ring->TxDescArray =
			dma_alloc_coherent(&pdev->dev, ring->TxDescAllocSize,
...
static int rtl8125_alloc_rx_desc(struct rtl8125_private *tp)
{
	...
	for (i = 0; i < tp->num_rx_rings; i++) {
		...
		ring->RxDescAllocSize =
			(ring->num_rx_desc + 1) * tp->RxDescLength;
		ring->RxDescArray =
			dma_alloc_coherent(&pdev->dev, ring->RxDescAllocSize,
...
static void rtl8125_free_tx_desc(struct rtl8125_private *tp)
{
	...
	for (i = 0; i < tp->num_tx_rings; i++) {
		ring = &tp->tx_ring[i];
		if (ring->TxDescArray) {
			dma_free_coherent(&pdev->dev, ring->TxDescAllocSize,
...
static void rtl8125_free_rx_desc(struct rtl8125_private *tp)
{
	...
	for (i = 0; i < tp->num_rx_rings; i++) {
		ring = &tp->rx_ring[i];
		if (ring->RxDescArray) {
			dma_free_coherent(&pdev->dev, ring->RxDescAllocSize,
...
static int rtl8125_alloc_rx_page(struct rtl8125_private *tp,
				 struct rtl8125_rx_ring *ring,
				 struct rtl8125_rx_buffer *rxb)
{
	...
	dma = dma_map_page_attrs(&tp->pci_dev->dev, page, 0,
				 tp->rx_buf_page_size, DMA_FROM_DEVICE,
...
static void rtl8125_free_rx_page(struct rtl8125_private *tp,
				 struct rtl8125_rx_buffer *rxb)
{
	if (!rxb->page)
		return;

	dma_unmap_page_attrs(&tp->pci_dev->dev, rxb->dma, tp->rx_buf_page_size,
			     DMA_FROM_DEVICE,
			   ...
			   u32 start, u32 end, u8 in_intr)
{
	...
	for (cur = start; end - cur > 0; cur++) {
		...
		dma_sync_single_range_for_device(tp_to_dev(tp), rxb->dma,
						 rxb->page_offset,
						 tp->rx_buf_sz,
						 DMA_FROM_DEVICE);

		rtl8125_map_to_asic(tp, ring, ring->RxDescArray + i,
				    rxb->dma + rxb->page_offset, tp->rx_buf_sz,
				    i);
	}
	return cur - start;
}
		...
		if (mss) {
			...
			case __constant_htons(ETH_P_IP):
				if (skb_transport_offset(skb) <= GTTCPHO_MAX) {
					opts[0] |= GiantSendv4;
					opts[0] |= skb_transport_offset(skb)
						   << GTTCPHO_SHIFT;
		...
		case __constant_htons(ETH_P_IPV6):
			if (dev->features & NETIF_F_IPV6_CSUM) {
				if (skb_transport_offset(skb) > 0 &&
				    skb_transport_offset(skb) <= TCPHO_MAX) {
					ip_protocol = ipv6_hdr(skb)->nexthdr;
					csum_cmd = tp->tx_ipv6_csum_cmd;
					csum_cmd |= skb_transport_offset(skb)
						    << TCPHO_SHIFT;
				}
			}
			break;
...
static inline u32 rtl8125_fast_mod_mask(const u32 input, const u32 mask)
{
...
static u32 rtl8125_get_hw_clo_ptr(struct rtl8125_tx_ring *ring)
{
...
static int rtl8125_tx_interrupt(struct rtl8125_tx_ring *ring, int budget)
{
	...
	if (EnableTxNoClose) {
		...
		smp_rmb();
		tx_desc_closed = rtl8125_fast_mod_mask(
...
static inline int rtl8125_is_non_eop(struct rtl8125_private *tp, u32 status)
{
	if (tp->InitRxDescType == RX_DESC_RING_TYPE_3)
...
static inline bool rtl8125_reuse_rx_ok(struct page *page)
{
...
static void rtl8125_reuse_rx_buffer(struct rtl8125_private *tp,
				    struct rtl8125_rx_ring *ring, u32 cur_rx,
				    struct rtl8125_rx_buffer *rxb)
{
	...
	noffset = rxb->page_offset ^
		  (tp->rx_buf_page_size / 2); //one page, two buffer, ping-pong
				  ...
				  struct rtl8125_rx_buffer *rxb)
{
	...
	dma_sync_single_range_for_device(tp_to_dev(tp), nrxb->dma,
					 nrxb->page_offset, tp->rx_buf_sz,
					 DMA_FROM_DEVICE);

	rtl8125_map_to_asic(tp, ring, ring->RxDescArray + entry,
			    nrxb->dma + nrxb->page_offset, tp->rx_buf_sz,
			    entry);
	...
	for (; rx_left > 0; rx_left--, cur_rx++) {
		...
		if (tp->EnablePtp) {
			...
			if (desc_type == RXDESC_TYPE_NEXT && rx_left > 0) {
				...
				desc_next =
					(struct RxDescV3 *)rtl8125_get_rxdesc(
						tp, ring->RxDescArray,
						entry_next);
				rmb();
				status_next = le32_to_cpu(
					desc_next->RxDescNormalDDWord4.opts1);
				...
				if (desc_type == RXDESC_TYPE_PTP)
					rtl8125_rx_ptp_pktstamp(tp, skb,
								desc_next);
				else
					WARN_ON(1);
		...
		rxb->skb = NULL;
		if (!skb) {
			skb = RTL_BUILD_SKB_INTR(rxb->data + rxb->page_offset -
							 ring->rx_offset,
						 tp->rx_buf_page_size / 2);
			if (!skb) {
			...
			skb_add_rx_frag(skb, skb_shinfo(skb)->nr_frags,
					rxb->page, rxb->page_offset, pkt_size,
					tp->rx_buf_page_size / 2);

		//recycle desc
		rtl8125_put_rx_buffer(tp, ring, cur_rx, rxb);

		dma_sync_single_range_for_cpu(tp_to_dev(tp), rxb->dma,
					      rxb->page_offset, tp->rx_buf_sz,
					      DMA_FROM_DEVICE);
#else //ENABLE_PAGE_REUSE
		skb = RTL_ALLOC_SKB_INTR(&tp->r8125napi[ring->index].napi,
					 pkt_size + R8125_RX_ALIGN);
		if (!skb) {
			//netdev_err(tp->dev, "Failed to allocate RX skb!\n");
			goto drop_packet;
		}
